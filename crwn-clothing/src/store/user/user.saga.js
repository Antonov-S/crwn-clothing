...
import { signInSucceess, signInFailed, signUpSuccess, signUpFailed, signOutSuccess, signOutFailed } from "./user.action";
...
export function* getSnapshotFromUserAuth(userAuth, additionalDetails) {
  try {
    ...
    yield put(signInSucceess({ id: userSnapshot.id, ...userSnapshot.data() }));
  } catch (error) {
